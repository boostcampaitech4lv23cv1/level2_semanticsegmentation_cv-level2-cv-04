...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint='https://github.com/czczup/ViT-Adapter/releases/download/v0.2.7/upernet_beit_adapter_large_480_80k_pascal_context_59.pth.tar'
    ),
    backbone=dict(
        type='BEiTAdapter',
        img_size=480,
...
lr_config = dict(_delete_=True, policy='poly',
                 ...
                 warmup_iters=1500,
                 warmup_ratio=1e-6,
                 power=1.0, min_lr=0.000001, by_epoch=False)
...
load_from = 'https://github.com/czczup/ViT-Adapter/releases/download/v0.2.7/upernet_beit_adapter_large_480_80k_pascal_context_59.pth.tar'
