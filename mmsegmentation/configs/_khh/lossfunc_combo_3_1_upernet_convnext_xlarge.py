...
model = dict(
    ...
    decode_head=dict(
        ...
        align_corners=False,
        loss_decode=[
            dict(type='CrossEntropyLoss', loss_name='loss_ce', loss_weight=3.),
            dict(type='DiceLoss', loss_name='loss_dice', loss_weight=1.)]),
    auxiliary_head=dict(
        type='FCNHead',
        in_channels=1024,
        in_index=2,
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint=
        '/opt/ml/mmsegmentation/pretrain/upernet_convnext_xlarge_fp16_640x640_160k_ade20k_20220226_080344-95fc38c2.pth'
    ))
    ...
    hooks=[
        ...
        dict(
            ...
            init_kwargs=dict(
                ...
                name='pretrain_segmentor_upernet_convnext_xlarge'),
            interval=10)
    ])
...
work_dir = './work_dirs/pretrain_segmentor_upernet_convnext_xlarge'
gpu_ids = [0]
auto_resume = False
